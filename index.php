						...
						<div class="crm-main">
							...
							<div class="crm-head">
								...
								<div class="crm-head-right">
									...
									<div class="head-right-add">
										<a href="#!" class="add-deal blue-btn">
											<span class="deal-icon">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z" fill="#fff"/>
												</svg>
											</span>
											<span class="deal-text">Добавить сделку</span>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="crm-head-tags">
								<div class="crm-tag-block">
									<div class="crm-tags">
										<a href="#!" class="tag">Договор отправлен</a>
										<a href="#!" class="tag">Оплачено</a>
										<a href="#!" class="tag">Переговоры</a>
								...
								<div class="crm-list">
									<div class="list-drop drop-block">
										<button class="list-btn transparent-btn" type="button">
											Список  <img src="images/drop-arrow.svg" alt="">
										</button>
										<ul class="list-menu drop-menu">
											<li><a href="#">Action</a></li>
											<li><a href="#">Another action</a></li>
								...
								<div class="table-responsive" id="style-2">
									...
									<thead>
										<tr>
											...
											<th class="thead-manager">
												<a href="#!">Менеджер</a>
											</th>
											<th class="thead-domen">
												<a href="#!">Домен</a>
											</th>
											<th class="thead-status">
												<a href="#!">Статус</a>
											</th>
											<th class="thead-reminder">
												<a href="#!">Напоминание</a>
											</th>
											<th class="thead-comment">
												<a href="#!">Комментарий</a>
											</th>
											<th class="thead-creat">
												<a href="#!">Создан</a>
											</th>
									...
									<tbody>
										<tr>
											...
											<td class="tb-contact">
												<a href="#!">
													<img src="images/table-user1.png" alt="">
													Леонид
												</a>
											</td>
											<td class="tb-tel">
											...
											<td class="tb-manager">
												<a href="#!">@agata.bakaeva	</a>
											</td>
											<td class="tb-domen">
												<a href="#!">Catlivan.ru</a>
											</td>
											<td class="tb-status">
												<p class="t-new">Новый</p>
											</td>
										...
										<tr>
											...
											<td class="tb-contact">
												<a href="#!">
													<img src="images/table-user2.png" alt="">
													Владислав
												</a>
											</td>
											<td class="tb-tel">
										...
										<tr>
											...
											<td class="tb-contact">
												<a href="#!">
													<img src="images/table-user3.png" alt="">
													Гость#234
												</a>
											</td>
											<td class="tb-tel">
										...
										<tr>
											...
											<td class="tb-contact">
												<a href="#!">
													<img src="images/table-user4.png" alt="">
													Светлана
												</a>
											</td>
											<td class="tb-tel">
										...
										<tr>
											...
											<td class="tb-contact">
												<a href="#!">
													<img src="images/table-user5.png" alt="">
													Ольга
												</a>
											</td>
											<td class="tb-tel">
											...
											<td class="tb-status">
												<p class="t-dealClose">Сделка закрыта</p>
											</td>
											<td class="tb-reminder active">
												<p>
													<span class="reminder-icon">
										...
										<tr>
											...
											<td class="tb-contact">
												<a href="#!">
													<img src="images/table-user6.png" alt="">
													Дмитрий
												</a>
											</td>
											<td class="tb-tel">
